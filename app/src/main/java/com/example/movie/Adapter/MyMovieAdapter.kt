...
//(private val context: Context, private val movieList: MutableList<Movie>):RecyclerView.Adapter<MyMovieAdapter.MyViewHolder>()
class MyMovieAdapter (private val context: Context, private val movieList: MutableList<Movie>): RecyclerView.Adapter<MyMovieAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(itemView: View):RecyclerView.ViewHolder(itemView) {
        ...
        val txt_created: TextView = itemView.txt_created
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.txt_created.text = movieList[position].createdby
    }
